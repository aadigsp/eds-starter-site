...
## Environments
- Preview: https://main--eds-starter-site--aadigsp.aem.page/
- Live: https://main--eds-starter-site--aadigsp.aem.live/
...
1. Open the `eds-starter-site` directory in your favorite IDE and start coding :)
